...
class FragmentOnboarding2 : BaseFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = layoutInflater.inflate(R.layout.fragment_onboarding2, container, false)
        return view
    }
    ...
    fun nextPage(){
        (activity as OnboardingActivity).changeViewPagerPage(2)
    }
}